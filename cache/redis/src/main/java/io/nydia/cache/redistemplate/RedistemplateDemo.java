...
// 一、String类型
    ...
    public void stringMethod(String key, String keys, String value, int offset, Long timeout, TimeUnit unit) {
    ...
    public Double incrByDouble2(String key, double increment) {
        return redisTemplate.opsForValue().increment(key, increment);
    }
...
//二、Hash类型
    ...
    public void hGet(String key, String field, String hashKey, String value) {
        //获取变量中的指定map键是否有值,如果存在该map键则获取值，没有则返回null；
        redisTemplate.opsForHash().get(key, field);
    }

    public void hashMethod(String key, String field, String hashKey, String value) {
...
// 三、 List类型
    ...
    public void listMethod(String key, int index, int start, int end
            , String value, String pivot, String destinationKey, String sourceKey
...
//四、Set类型
    ...
    public void setMethod(String key, String otherKey, String value
            , String values, ScanOptions options, String otherKeys
            , String destKey, int count) {
        //添加元素；
...
//五、zSet类型
    ...
    public void zSetMethod(String key, String value, int score
            , String values, double delta, int start, int end, int min, int max
            , String otherKey, String destKey) {
        ...
        //遍历集合（和iterator一模一样）；
        Cursor<ZSetOperations.TypedTuple<Object>> scan = redisTemplate.opsForZSet().scan("test3", ScanOptions.NONE);
        while (scan.hasNext()) {
