package com.nydia.dddmessage.test.domain.specification;

import com.nydia.dddmessage.domain.aggregate.message.entity.Message;
import com.nydia.dddmessage.domain.aggregate.message.specification.BlockedSpecification;
import com.nydia.dddmessage.domain.aggregate.message.specification.SafetySpecification;
import com.nydia.dddmessage.domain.aggregate.message.specification.StopWordSpecification;
...
import com.nydia.dddmessage.domain.shared.specification.AndSpecification;
import com.nydia.dddmessage.domain.shared.specification.InteractiveSpecification;
import com.nydia.dddmessage.domain.shared.specification.Specification;
