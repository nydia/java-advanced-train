...
import com.nydia.agent.log4j.core.config.builder.api.ConfigurationBuilderFactory;
...
import com.nydia.agent.log4j.core.util.FileUtils;
...
import com.nydia.agent.log4j.core.config.plugins.util.PluginManager;
import com.nydia.agent.log4j.core.config.plugins.util.PluginType;
import com.nydia.agent.log4j.core.config.xml.XmlConfigurationFactory;
import com.nydia.agent.log4j.core.lookup.Interpolator;
import com.nydia.agent.log4j.core.lookup.StrSubstitutor;
...
public abstract class ConfigurationFactory extends ConfigurationBuilderFactory {
     ...
     */
    protected static final String TEST_PREFIX = "nydia-agent-log4j2-test";

    /**
     * File name prefix for standard configurations.
     */
    protected static final String DEFAULT_PREFIX = "nydia-agent-log4j2";
