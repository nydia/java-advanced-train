package com.nydia.ai.core.vectorstore;
...
public class VectorStoreConfig {
    ...
    /**
     * 定义一个名为 vectorStoreNydia 的Bean，用于创建并返回一个 VectorStore 实例。
     ...
     */
    @Bean(name = "vectorStoreNydia")
    public VectorStore vectorStoreNydia(MilvusServiceClient milvusClient, EmbeddingModel embeddingModel) {
