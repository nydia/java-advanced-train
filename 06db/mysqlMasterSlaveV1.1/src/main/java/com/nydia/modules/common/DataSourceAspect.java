...
public class DataSourceAspect {
    ...
    //切点
    @Pointcut("execution(* com.nydia.modules.service..*.*(..)))")
    public void aspect() { }
    ...
    private void before(JoinPoint point) {
        ...
        try {
            ...
            if (m != null && m.isAnnotationPresent(Slave1DataSource.class)) {
                Slave1DataSource data = m.getAnnotation(Slave1DataSource.class);
