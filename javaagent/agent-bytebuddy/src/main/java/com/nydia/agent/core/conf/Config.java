...
import com.nydia.agent.core.logging.core.LogLevel;
import com.nydia.agent.core.logging.core.LogOutput;
import com.nydia.agent.core.logging.core.ResolverType;
import com.nydia.agent.core.logging.core.WriterFactory;
import com.nydia.agent.core.plugin.ClassCacheMode;
import com.nydia.agent.core.util.Length;
...
public class Config {
    ...
    public static class Meter {
        ...
        /**
         * Max size of the meter count, using {@link com.nydia.agent.core.meter.MeterId} as identity
         */
    ...
    public static class Logging {
         ...
         *
         * @see com.nydia.agent.core.logging.core.PatternLogger#DEFAULT_CONVERTER_MAP
         */
