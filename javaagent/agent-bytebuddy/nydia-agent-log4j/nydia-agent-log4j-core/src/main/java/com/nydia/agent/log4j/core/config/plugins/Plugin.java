...
public @interface Plugin {
     ...
     * indicate an {@link com.nydia.agent.log4j.core.Appender} plugin which would be in the
     * {@code <Appenders/>} element of a {@link com.nydia.agent.log4j.core.config.Configuration}.
     */
