 ...
 */
package com.nydia.agent.log4j.core.appender.rolling.action;
...
public class PosixViewAttributeAction extends AbstractPathAction {
     ...
     */
    public static class Builder implements com.nydia.agent.log4j.core.util.Builder<PosixViewAttributeAction> {
