...
import com.nydia.agent.log4j.core.util.datetime.FastDateFormat;
import com.nydia.agent.log4j.core.util.datetime.FixedDateFormat;
import com.nydia.agent.log4j.core.util.datetime.FixedDateFormat.FixedFormat;
