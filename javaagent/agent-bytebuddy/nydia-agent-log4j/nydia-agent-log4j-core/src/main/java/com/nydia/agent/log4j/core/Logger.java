...
import com.nydia.agent.log4j.core.filter.CompositeFilter;
...
/**
 * The core implementation of the {@link com.nydia.agent.log4j.Logger} interface. Besides providing an implementation
 * of all the Logger methods, this class also provides some convenience methods for Log4j 1.x compatibility as well as
 * access to the {@link Filter Filters} and {@link org.apache.logging.log4j.core.Appender
