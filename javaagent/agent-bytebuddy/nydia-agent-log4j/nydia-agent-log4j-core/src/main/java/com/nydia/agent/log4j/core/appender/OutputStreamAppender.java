...
import com.nydia.agent.log4j.core.util.CloseShieldOutputStream;
/**
...
public final class OutputStreamAppender extends AbstractOutputStreamAppender<OutputStreamManager> {
     ...
     */
    public static class Builder implements com.nydia.agent.log4j.core.util.Builder<OutputStreamAppender> {
