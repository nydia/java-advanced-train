...
import com.nydia.agent.log4j.core.pattern.LogEventPatternConverter;
import com.nydia.agent.log4j.core.pattern.PatternFormatter;
import com.nydia.agent.log4j.core.pattern.PatternParser;
import com.nydia.agent.log4j.core.pattern.RegexReplacement;
 ...
 * <p>
 * The goal of this class is to {@link com.nydia.agent.log4j.core.Layout#toByteArray format} a {@link LogEvent} and
...
public final class PatternLayout extends AbstractStringLayout {
    ...
    public static class SerializerBuilder implements com.nydia.agent.log4j.core.util.Builder<Serializer> {
     ...
     */
    public static class Builder implements com.nydia.agent.log4j.core.util.Builder<PatternLayout> {
