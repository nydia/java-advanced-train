 ...
 * using the {@link com.nydia.agent.log4j.status.StatusLogger}. Appenders should only throw exceptions when an error
 ...
 * that instruction. See {@link com.nydia.agent.log4j.core.Appender#ignoreExceptions()}, which is the standard
 * way to do this.
 */
