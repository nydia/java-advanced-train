 ...
 */
package com.nydia.agent.log4j.message;

import com.nydia.agent.log4j.util.BiConsumer;
import com.nydia.agent.log4j.util.EnglishEnums;
import com.nydia.agent.log4j.util.IndexedReadOnlyStringMap;
import com.nydia.agent.log4j.util.IndexedStringMap;
import com.nydia.agent.log4j.util.PerformanceSensitive;
import com.nydia.agent.log4j.util.ReadOnlyStringMap;
import com.nydia.agent.log4j.util.SortedArrayStringMap;
import com.nydia.agent.log4j.util.StringBuilderFormattable;
import com.nydia.agent.log4j.util.StringBuilders;
import com.nydia.agent.log4j.util.Strings;
import com.nydia.agent.log4j.util.TriConsumer;
