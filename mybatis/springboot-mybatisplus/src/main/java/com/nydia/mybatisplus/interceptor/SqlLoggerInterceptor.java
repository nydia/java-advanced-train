package com.nydia.mybatisplus.interceptor;
 ...
 * @Date: 2024/5/30 22:03
 * @Description: SqlLoggerInterceptor
 */
@Intercepts({
        ...
        @Signature(type = Executor.class, method = "query", args = {MappedStatement.class, Object.class, RowBounds.class, ResultHandler.class, CacheKey.class, BoundSql.class}), @Signature(type = Executor.class, method = "query", args = {MappedStatement.class, Object.class, RowBounds.class, ResultHandler.class})//需要代理的对象和方法
})
@Slf4j
public class SqlLoggerInterceptor implements Interceptor {
    ...
    public Object intercept(Invocation invocation) throws Throwable {
        ...
        String sqlId = mappedStatement.getId();//获得mybatis的*mapper.xml文件中映射的方法，如：com.nydia.mybatisplus.mapper.UserMapper.selectById
